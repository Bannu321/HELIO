                ...
                <span
                  className={`px-2.5 py-1 rounded-md text-xs font-bold ${
                    row.type === "Export"
                      ...
                      : "bg-slate-300 dark:bg-void-700 text-slate-700 dark:text-void-300"
                  }`}
                >
                  {row.type}
                </span>
...
function StatusBadge({ status }) {
  const config = {
    Settled: {
      icon: CheckCircle2,
      color: "text-energy-green bg-energy-green/10 border-energy-green/20",
    },
    Pending: {
      icon: Clock,
      color: "text-energy-amber bg-energy-amber/10 border-energy-amber/20",
    },
    Failed: {
      icon: AlertCircle,
      color: "text-energy-rose bg-energy-rose/10 border-energy-rose/20",
    },
  };
