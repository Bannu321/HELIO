    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8 lg:py-12 space-y-10 animate-fade-in">
      <header>
        ...
        <p className="text-sm text-slate-600 dark:text-void-300 mt-1 font-mono">
          Perez Irradiance Model & Forecast Diagnostics
        </p>
      </header>
        ...
        <div className="bg-white dark:bg-void-800 border border-slate-300 dark:border-void-700 rounded-2xl p-8 shadow-card relative overflow-hidden flex flex-col">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-display font-bold text-slate-900 dark:text-white">
              LSTM Generation Forecast
            </h2>
          </div>

          <div className="flex-1 space-y-6">
            <div className="bg-slate-100 dark:bg-void-900 border border-slate-300 dark:border-void-700 rounded-xl p-4">
              <div className="text-xs text-slate-600 dark:text-void-400 font-mono mb-1">
                PREDICTED YIELD (NEXT 6 HOURS)
              </div>
              <div className="text-3xl font-display font-bold text-energy-cyan">
                18.5{" "}
                <span className="text-lg text-slate-600 dark:text-void-300">
                  kWh
                </span>
              </div>
              <p className="text-xs text-slate-600 dark:text-void-300 mt-2">
                Confidence:{" "}
                <span className="text-energy-green">High (94%)</span>
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-slate-600 dark:text-void-300">
                <li className="flex gap-2">
                  <span className="text-solar-400">▹</span> Peak irradiance
                  expected at 13:15 IST.
                </li>
                <li className="flex gap-2">
                  <span className="text-solar-400">▹</span> Minor cloud cover
                  arriving at 15:00, expected drop: 12%.
                </li>
                <li className="flex gap-2">
                  <span className="text-energy-rose">▹</span> Panel temp
                  exceeding 40°C causing -1.5% thermal efficiency loss.
                </li>
              </ul>
            </div>
          </div>
