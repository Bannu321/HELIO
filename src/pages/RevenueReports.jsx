  ...
  return (
    <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8 lg:py-12 space-y-10 animate-fade-in">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="font-display text-2xl font-extrabold text-slate-900 dark:text-white tracking-wide">Revenue & Settlements</h1>
          <p className="text-sm text-slate-600 dark:text-void-300 mt-1 font-mono">Energy export logs and net metering financials</p>
        </div>
      ...
      <div className="bg-white dark:bg-void-800 border border-slate-300 dark:border-void-700 rounded-2xl p-6 shadow-card">
        <h2 className="font-display font-bold text-slate-900 dark:text-white mb-6">Settlement Ledger</h2>
        <RevenueTable />
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-slate-100 dark:bg-void-800/50 border border-slate-300 dark:border-void-700 rounded-2xl p-6 shadow-card flex flex-col">
      <div className="flex justify-between items-start mb-4">
        ...
        <div className={`p-2 rounded-lg bg-slate-200 dark:bg-void-900 border border-slate-300 dark:border-void-700 ${color}`}>
          <Icon className="w-5 h-5" />
        </div>
      </div>
      <div className="mt-auto">
        <div className="text-3xl font-display font-bold text-slate-900 dark:text-white mb-1">{value}</div>
        <div className="text-xs font-mono text-slate-600 dark:text-void-400">{trend}</div>
      </div>
    </div>
  );
}