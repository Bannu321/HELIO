...
const alertsData = [
  { id: 1, type: 'critical', title: 'Inverter Comm Loss', time: '10 mins ago', desc: 'Lost connection to Inverter A. Attempting reconnect.' },
  { id: 2, type: 'warning', title: 'Soiling Loss Detected', time: '2 hours ago', desc: 'Dust accumulation on Array B reducing output by 2.1%. Maintenance recommended.' },
  { id: 3, type: 'info', title: 'Grid Tariff Updated', time: '5 hours ago', desc: 'DISCOM peak tariff period started. Export profitability increased.' },
  { id: 4, type: 'success', title: 'System Optimal', time: 'Yesterday', desc: 'Daily generation exceeded estimation by 4%.' },
];
...
function AlertRow({ alert }) {
  const config = {
    critical: { icon: ShieldAlert, color: 'text-energy-rose', bg: 'bg-energy-rose/10', border: 'border-energy-rose/30' },
    warning: { icon: AlertTriangle, color: 'text-energy-amber', bg: 'bg-energy-amber/10', border: 'border-energy-amber/30' },
    info: { icon: Info, color: 'text-energy-cyan', bg: 'bg-energy-cyan/10', border: 'border-energy-cyan/30' },
    success: { icon: CheckCircle2, color: 'text-energy-green', bg: 'bg-energy-green/10', border: 'border-energy-green/30' },
  };
